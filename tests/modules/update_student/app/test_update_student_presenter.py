...
class Test_GetStudentPresenter:
    ...
    def test_update_student_invalid_name(self):
        event = {
            ...
            "body": '{"ra": "21014440","new_name": "a","new_email": "maluzinha@teamo.com","parameter2": "value" }',
            "pathParameters": None,
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        ...
        response = lambda_handler(event, None)
        assert response["statusCode"] == 400
        assert json.loads(response["body"]) == f"name length must be bigger than {Student.MIN_NAME_LENGTH}"
