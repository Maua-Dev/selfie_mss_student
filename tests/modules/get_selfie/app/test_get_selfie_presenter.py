...
from src.modules.get_selfie.app.get_selfie_presenter import lambda_handler
...
class Test_GetSelfiePresenter:
    ...
    def test_get_selfie(self):
        ...
        assert json.loads(response["body"])["url"] == "https://drive.google.com/uc?id=12ZARnQJpkmm9dxprC8i9O7DkQPeiL0zu"
    ...
    def test_get_selfie_found(self):
        event = {
          "version": "2.0",
          "routeKey": "$default",
          "rawPath": "/my/path",
    ...
    def test_get_selfie_idSelfie_is_missing(self):
        event = {
          "version": "2.0",
          "routeKey": "$default",
          "rawPath": "/my/path",
    ...
    def test_get_selfie_student_not_found(self):
        event = {
          "version": "2.0",
          "routeKey": "$default",
          "rawPath": "/my/path",
