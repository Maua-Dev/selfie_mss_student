import pytest
from src.modules.get_selfie.get_selfie_presenter import lambda_handler
...
class Test_GetSelfiePresenter:
    ...
    def test_get_selfie(self):
        ...
        assert response["body"]["url"] == "https://drive.google.com/uc?id=12ZARnQJpkmm9dxprC8i9O7DkQPeiL0zu"
