...
class Test_GetSelfiePresenter:
    ...
    def test_update_selfie(self):
        ...
        assert json.loads(response["body"])["student"]["ra"] == "21014440"
    ...
    def test_update_selfie_non_valid_ra_dash(self):
        event = {
            ...
            "body": '{"ra": "2101444-0","idSelfie": "0","parameter2": "value" }',          "pathParameters": None,
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        }
    ...
    def test_update_selfie_already_approved(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
            ...
            "body": '{"ra": "21010757","idSelfie": "0","parameter2": "value" }',          "pathParameters": None,
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        }
    ...
    def test_update_selfie_already_rejected(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
            ...
            "body": '{"ra": "21002088","idSelfie": "0","parameter2": "value" }',          "pathParameters": None,
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        }
