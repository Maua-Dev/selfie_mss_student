...
class Test_Selfie():
  ...
  labels = [Label(
    ...
    Label(
      ...
      Label(
        ...
        assert selfie.rejectionReasons == [REJECTION_REASON.COVERED_FACE]
        assert selfie.rejectionDescription == "Balaclava"
        assert selfie.automaticReview.automaticallyRejected == True        
    
    def test_selfie_list_rejection_reason(self):
  ...
  labels = [Label(
    ...
    Label(
      ...
      Label(
        ...
        assert selfie.dateCreated == dateCreated
        assert selfie.state == STATE.DECLINED
        assert selfie.rejectionReasons == [REJECTION_REASON.COVERED_FACE, REJECTION_REASON.NO_PERSON_RECOGNIZED]
        assert selfie.rejectionDescription == "Balaclava"
        assert selfie.automaticReview.automaticallyRejected == True        
  ...
  labels = [Label(
    ...
    def test_selfie_error_rejectionReasons_str(self):
      with pytest.raises(EntityError):
        selfie = Selfie(
                student= Student(
                                ra="17090212",
