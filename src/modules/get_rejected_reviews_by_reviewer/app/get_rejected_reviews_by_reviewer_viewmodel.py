...
class GetRejectedSelfiesByReviewerViewModel:
    rejectedSelfies: List[ReviewViewModel] 
    reviewer: ReviewerViewModel


    def __init__(self, listRejectedReviews: List[Review], reviewer: Reviewer):
        self.rejectedSelfies = [ReviewViewModel(review) for review in listRejectedReviews]
        self.reviewer = ReviewerViewModel(reviewer=reviewer)
        
    def to_dict(self) -> dict:
        return {
            "reviewer": self.reviewer.to_dict(),
            "rejectedSelfies": [review.to_dict() for review in self.rejectedSelfies],
