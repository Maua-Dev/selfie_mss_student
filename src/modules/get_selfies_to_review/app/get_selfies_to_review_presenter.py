...
from .get_selfies_to_review_controller import GetSelfiesToReviewController
...
def lambda_handler(event, context):
    ...
    usecase = GetSelfiesToReviewUsecase(repo)
    controller = GetSelfiesToReviewController(usecase)
