...
class ApproveSelfieUsecase:
    ...
    def __call__(self, studentRa: str, idSelfie: int, idReview: int) -> Review:
        ...
        review = self.repo.approve_selfie(idReview=idReview, idSelfie=idSelfie, studentRa=studentRa)
